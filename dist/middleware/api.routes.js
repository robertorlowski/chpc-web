...
router.get('/operation', operation_controller_1.getOperation);
router.post('/operation/set', operation_controller_1.setOperation);
router.get('/hp', hp_controller_1.getHp);
router.get('/hp/all', hp_controller_1.getHpAll);
